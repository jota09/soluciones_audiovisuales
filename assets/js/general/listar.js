        ...
        "ajax": {
            ...
            "data": function (d) {
                if (!jQuery.isEmptyObject(s3vars._filtros)) {
                    ...
                    d.filtroAsignado = $('#filtroAsignado').val();
                    d.filtroClasificacion = $('#filtroClasificacion').val();
                    d.filtroNaturaleza = $('#filtroNaturaleza').val();
                    d.filtroLinea = $('#filtroLinea').val();
                    d.filtroCuenta = $('#filtroCuenta').val();
                    d.filtroFechaCierre21 = $('#filtroFechaCierre21').val();
                    d.filtroFechaFactura22 = $('#filtroFechaFactura22').val();
                    d.filtroNumeroFactura = $('#filtroNumeroFactura').val();
                    d.filtroOportunidad = $('#filtroOportunidad').val();
                    d.filtroCargo = $('#filtroCargo').val();
                    d.filtroEtapa = $('#filtroEtapa').val();
                    d.filtroSegmento = $('#filtroSegmento').val();
                    d.filtroTomaContacto = $('#filtroTomaContacto').val();
                }
            }
        },
        "columns": columnas,
