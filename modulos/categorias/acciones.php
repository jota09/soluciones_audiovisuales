...
class AccionesCategorias extends S3Accion {
  ...
  public function accionEditar() {
    ...
    $cate_prod = $categoria2->ObtenerSubCategorias($peticion['parametros']['registro']);
    $aplicacion->getVista()->assign('cantidad_productos', $producto->productosXCategoria($cate_prod));
