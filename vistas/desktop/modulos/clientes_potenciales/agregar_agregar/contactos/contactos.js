function agregarContacto() {
    var html = '<div  class="col-lg-12 form-group">' +
            ...
            '<div class="col-lg-4">' +
            '<input type="text" class="form-control validate[required]"  id="contacto_nombre" name="contacto_nombre[]" >' +
            '</div>' +
            '<div class=" col-lg-3">' +
            '<input type="text" class="form-control validate[required]"  id="contacto_apellido" name="contacto_apellido[]" >' +
            '</div>' +
            '<div class="col-lg-2">' +
            '<input type="text" class="form-control validate[required]"  id="contacto_cargo" name="contacto_cargo[]" >' +
            '</div>' +
            '<div class="col-lg-1">' +
